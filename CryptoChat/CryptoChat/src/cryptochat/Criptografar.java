...
public class Criptografar {
    ...
    public static String cripto(String entrada, int valor1, int valor2, int valor3, int valor4) {
    ...
    public static String descrip(String entrada, int valor1, int valor2, int valor3, int valor4){
        int matriz[][] = new int[2][2];
        String texto = entrada;
        String saida = "";
    ...
    public static String toSHA(String entrada) {
        try {
            final MessageDigest md = MessageDigest.getInstance("SHA-256");
            final byte[] hash = md.digest(entrada.getBytes());
