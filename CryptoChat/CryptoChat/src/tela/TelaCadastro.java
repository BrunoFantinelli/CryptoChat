...
public class TelaCadastro extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(valor3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
                            .addComponent(valor1, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(10, 10, 10)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(valor2)
                            .addComponent(valor4, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)))
                    .addComponent(jLabel2)
                    .addComponent(jLabel3)
                    .addComponent(jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                    .addComponent(jButton2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(campoSenha)
                    .addComponent(campoConfirmSenha))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        User aux = new User();
        if (!campoSenha.getText().equals(campoConfirmSenha.getText())) {
        ...
        int det = (V1*V4)-(V2*V3);
        if(det == 0){
            JOptionPane.showMessageDialog(null, "Matriz Invalida. Determinante = 0.");
            return;
        }
        
        String teste = valor1.getText() + valor2.getText() + valor3.getText() + valor4.getText();
        aux.setId(Criptografar.toSHA(teste));
        aux.setSenha(Criptografar.toSHA(campoSenha.getText()));
        aux.mensagens.add(Criptografar.cripto("bemvindo", V1, V2, V3, V4));
        Firebase.inserirUsuario(aux);
        this.dispose();
